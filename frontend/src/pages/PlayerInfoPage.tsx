...
export default function PlayerInfoPage() {
    ...
    return (
        ...
        <div className="mt-50 flex flex-col items-center p-7 w-full text-justify">
            ...
            <p className="text-2xl text-[28px] mt-8"> <input type="checkbox" className="scale-200 ml-2 accent-green-300 cursor-pointer"/> Tôi đồng ý với các điều khoản và điều kiện của Chính sách bảo vệ dữ liệu cá nhân của RedBull</p>  
            <UIButton 
                label="Xác nhận" 
